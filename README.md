...
Read [this](https://telegram.dog/i_primeroom_01/12) before you start messing up with your edits.
...
* `CUSTOM_CAPTION `: Change The Caption Of Files With your desired Text
...
<p>
<pre>
git clone https://github.com/Primebot919
# Install Packages
